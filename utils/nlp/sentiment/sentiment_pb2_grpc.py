...
import utils.nlp.sentiment.sentiment_pb2 as sentiment__pb2
...
class Sentiment(object):
    ...
    def GetSentiment(request,
        ...
        return grpc.experimental.unary_unary(
            request, target, '/sentiment.Sentiment/GetSentiment',
            sentiment__pb2.TextInput.SerializeToString,
            sentiment__pb2.Results.FromString, options, channel_credentials,
